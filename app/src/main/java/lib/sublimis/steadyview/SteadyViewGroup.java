 ...
 */
public abstract class SteadyViewGroup extends ViewGroup implements ISteadyView
{
   public SteadyViewGroup(final Context context)
   {
      super(context);
   ...
   public SteadyViewGroup(final Context context, final AttributeSet attrs)
   {
      super(context, attrs);
   ...
   public SteadyViewGroup(final Context context, final AttributeSet attrs, final int defStyleAttr)
   {
   ...
   public SteadyViewGroup(final Context context, final AttributeSet attrs, final int defStyleAttr, final int defStyleRes)
   {
